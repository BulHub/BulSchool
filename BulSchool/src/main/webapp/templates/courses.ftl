            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="course-1-item">
                            <figure class="thumnail">
                                <a href="${rc.getContextPath()}/course/net"><img src="${rc.getContextPath()}/templates/images/course_3.jpg" alt="Image" class="img-fluid"></a>
                                <div class="price">$99.00</div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="course-1-item">
                            <figure class="thumnail">
                                <a href="${rc.getContextPath()}/course/database"><img src="${rc.getContextPath()}/templates/images/course_5.jpg" alt="Image" class="img-fluid"></a>
                                <div class="price">$99.00</div>
