...
<div class="login-dark">
    <form method="post" autocomplete="off" id="form">
        ...
        <div class="form-group"><input style="color:yellow" class="form-control" type="password" name="password" id="password" placeholder="New password" required="required" max="30"></div>
        <div class="form-group"><input style="color: yellow" class="form-control" type="password" name="rePassword" id="rePassword" placeholder="New re-password" required="required"
                                       max="30">
        </div>
        <div class="form-group">
            <button class="btn btn-primary btn-block" type="submit" onclick="return validateForm()">Change password</button>
        </div>
