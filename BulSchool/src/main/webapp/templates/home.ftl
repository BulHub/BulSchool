...
<head>
  ...
  <link href="${rc.getContextPath()}/templates/css/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
...
<div class="hero-slide owl-carousel site-blocks-cover">
  <div class="intro-section" style="background-image: url('.//templates/images/hero_1.jpg');">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
          <h1>BulSchool University</h1>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="owl-slide-3 owl-carousel">
          ...
          <div class="course-1-item">
            <figure class="thumnail">
              <a href="${rc.getContextPath()}/course/php"><img src="${rc.getContextPath()}/templates/images/course_2.jpg" alt="Image" class="img-fluid"></a>
              <div class="price">$99.00</div>
          ...
          <div class="course-1-item">
            <figure class="thumnail">
              <a href="${rc.getContextPath()}/course/python"><img src="${rc.getContextPath()}/templates/images/course_3.jpg" alt="Image" class="img-fluid"></a>
              <div class="price">$99.00</div>
          ...
          <div class="course-1-item">
            <figure class="thumnail">
              <a href="${rc.getContextPath()}/course/iOs"><img src="${rc.getContextPath()}/templates/images/course_4.jpg" alt="Image" class="img-fluid"></a>
              <div class="price">$99.00</div>
          ...
          <div class="course-1-item">
            <figure class="thumnail">
              <a href="${rc.getContextPath()}/course/net"><img src="${rc.getContextPath()}/templates/images/course_5.jpg" alt="Image" class="img-fluid"></a>
              <div class="price">$99.00</div>
          ...
          <div class="course-1-item">
            <figure class="thumnail">
              <a href="${rc.getContextPath()}/course/database"><img src="${rc.getContextPath()}/templates/images/course_6.jpg" alt="Image" class="img-fluid"></a>
              <div class="price">$99.00</div>
...
<div class="section-bg style-1" style="background-image: url('.//templates/images/about_1.jpg');">
  <div class="container">
    <div class="row">
      <div class="col-lg-4">
    ...
    <div class="owl-slide owl-carousel">
      ...
      <div class="ftco-testimonial-1">
        <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
          <img src="${rc.getContextPath()}/templates/images/person_1.jpg" alt="Image" class="img-fluid mr-3">
          <div>
      ...
      <div class="ftco-testimonial-1">
        <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
          <img src="${rc.getContextPath()}/templates/images/person_2.jpg" alt="Image" class="img-fluid mr-3">
          <div>
            <h3>Allison Holmes</h3>
            <span>Designer</span>
          </div>
      ...
      <div class="ftco-testimonial-1">
        <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
          <img src="${rc.getContextPath()}/templates/images/person_4.jpg" alt="Image" class="img-fluid mr-3">
          <div>
            <h3>Allison Holmes</h3>
            <span>Designer</span>
          </div>
      ...
      <div class="ftco-testimonial-1">
        <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
          <img src="${rc.getContextPath()}/templates/images/person_3.jpg" alt="Image" class="img-fluid mr-3">
          <div>
            <h3>Allison Holmes</h3>
            <span>Designer</span>
          </div>
    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="post-entry-big">
              <a href="news-single.html" class="img-link"><img src="${rc.getContextPath()}/templates/images/blog_large_1.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-lg-6">
            <div class="post-entry-big horizontal d-flex mb-4">
              <a href="news-single.html" class="img-link mr-4"><img src="${rc.getContextPath()}/templates/images/blog_1.jpg" alt="Image" class="img-fluid"></a>
              <div class="post-content">
                <div class="post-meta">
                  <a href="#">June 6, 2019</a>
                  <span class="mx-1">/</span>
            ...
            <div class="post-entry-big horizontal d-flex mb-4">
              <a href="news-single.html" class="img-link mr-4"><img src="${rc.getContextPath()}/templates/images/blog_2.jpg" alt="Image" class="img-fluid"></a>
              <div class="post-content">
                <div class="post-meta">
                  <a href="#">June 6, 2019</a>
                  <span class="mx-1">/</span>
      ...
      <div class="col-lg-3">
        ...
        <a href="https://vimeo.com/45830194" class="video-1 mb-4" data-fancybox="" data-ratio="2">
          ...
          <img src="${rc.getContextPath()}/templates/images/course_5.jpg" alt="Image" class="img-fluid">
        </a>
        <a href="https://vimeo.com/45830194" class="video-1 mb-4" data-fancybox="" data-ratio="2">
                <span class="play">
                  <span class="icon-play"></span>
...
<div class="site-section ftco-subscribe-1" style="background-image: url('.//templates/images/bg_1.jpg')">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7">
