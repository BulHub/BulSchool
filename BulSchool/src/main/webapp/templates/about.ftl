        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <img src="${rc.getContextPath()}/templates/images/course_4.jpg" alt="Image" class="img-fluid">
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
                    ...
                    <div class="feature-1 border person text-center">
                        <img src="${rc.getContextPath()}/templates/images/person_1.jpg" alt="Image" class="img-fluid">
                ...
                <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
                    <div class="feature-1 border person text-center">
                        <img src="${rc.getContextPath()}/templates/images/person_2.jpg" alt="Image" class="img-fluid">
                        <div class="feature-1-content">
                ...
                <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
                    <div class="feature-1 border person text-center">
                        <img src="${rc.getContextPath()}/templates/images/person_3.jpg" alt="Image" class="img-fluid">
                        <div class="feature-1-content">
                            <h2>Jonas Tabble</h2>
                            <span class="position mb-3 d-block">Math Teacher</span>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit morbi hendrerit elit</p>
                ...
                <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
                    ...
                    <div class="feature-1 border person text-center">
                        <img src="${rc.getContextPath()}/templates/images/person_4.jpg" alt="Image" class="img-fluid">
                        <div class="feature-1-content">
                            <h2>Craig Daniel</h2>
                            <span class="position mb-3 d-block">Math Teacher</span>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit morbi hendrerit elit</p>
