        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <img src="${rc.getContextPath()}/templates/images/course_6.jpg" alt="Image" class="img-fluid">
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
                    <img src="${rc.getContextPath()}/templates/images/course_3.jpg" alt="Image" class="img-fluid">
                </div>
